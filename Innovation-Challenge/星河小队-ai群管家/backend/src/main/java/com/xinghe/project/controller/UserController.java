...
import com.xinghe.project.common.DeleteRequest;
...
import com.xinghe.project.model.dto.user.*;
...
public class UserController {
    ...
    public R<UserVO> getLoginUser(HttpServletRequest request) {
    ...
    public R<Long> addUser(@RequestBody UserAddRequest userAddRequest, HttpServletRequest request) {
        ...
        return RUtils.success(user.getId());
    }
     ...
     */
    @GetMapping("/get")
    public R<UserVO> getUserById(int id, HttpServletRequest request) {
        if (id <= 0) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR);
        }
     ...
     */
    @GetMapping("/list")
    public R<List<UserVO>> listUser(UserQueryRequest userQueryRequest, HttpServletRequest request) {
        ...
        return RUtils.success(userVOList);
    }
    ...
    public R<Page<UserVO>> listUserByPage(UserQueryRequest userQueryRequest, HttpServletRequest request) {
        long current = 1;
        long size = 10;
        User userQuery = new User();
        if (userQueryRequest != null) {
        ...
        return RUtils.success(userVOPage);
    }
