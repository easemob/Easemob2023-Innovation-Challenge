...
class HttpPersistent{
  ...
  static Map<String, String>? _storeMap(String baseUrl, int type){
    return (StoreManager.store as LibStore).getStringMap('${SysConfig.sysPersistent}${baseUrl}_${type.toString()}',safe: true);

  }

  static _saveStoreMap(String baseUrl, int type,Map<String, String> value){
    (StoreManager.store as LibStore).setStringMap('${SysConfig.sysPersistent}${baseUrl}_${type.toString()}',value,safe: true);
  }

  static _clear(String baseUrl, int type){
    StoreManager.store.remove('${SysConfig.sysPersistent}${baseUrl}_${type.toString()}');
  }
