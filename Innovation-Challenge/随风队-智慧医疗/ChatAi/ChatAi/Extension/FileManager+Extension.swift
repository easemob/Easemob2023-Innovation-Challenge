...
public extension FileManager {
    ...
    /// 主目录
    static func MainDirectory() -> String {
        let mainPath = NSHomeDirectory() + "/Library/Main"
        return mainPath
    }
    ///账号目录
    static func MainAccountDirectory() -> String {
        let mainAccountPath = NSHomeDirectory() + "/Library/Main/Account"
        return mainAccountPath
    }
    ///图片目录
    static func MainImageDirectory() -> String {
        let mainImagePath = NSHomeDirectory() + "/Library/Main/Image"
        return mainImagePath
    }
    ///视频目录
    static func MainVideoDirectory() -> String {
        let mainVideoPath = NSHomeDirectory() + "/Library/Main/Video"
        return mainVideoPath
    }
    ///音频目录
    static func MainVoiceDirectory() -> String {
        let mainVoicePath = NSHomeDirectory() + "/Library/Main/Voice"
        return mainVoicePath
    }
    ///文档目录
    static func MainDocumentDirectory() -> String {
        let mainDocumentPath = NSHomeDirectory() + "/Library/Main/Document"
        return mainDocumentPath
    }
    /// 应用目录
    static func MainAppDirectory() -> String {
        let mainAppPath = NSHomeDirectory() + "/Library/Main/App"
        return mainAppPath
    }
    /// 加密目录
    static func MainEncryptDirectory() -> String {
        let mainEncryptPath = NSHomeDirectory() + "/Library/Main/Encrypt"
        return mainEncryptPath
    }
    /// 通用目录
    static func MainCommonDirectory() -> String {
        let mainCommonPath = NSHomeDirectory() + "/Library/Main/Common"
        return mainCommonPath
    }
    /// 缩略图目录
    static func MainThumbnailDirectory() -> String {
        let mainThumbnailPath = NSHomeDirectory() + "/Library/.Thumbnail"
