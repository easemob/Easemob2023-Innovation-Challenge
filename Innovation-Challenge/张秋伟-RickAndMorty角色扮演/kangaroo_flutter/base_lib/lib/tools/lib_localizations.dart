...
class ChLibString implements LibString {
  ...
  @override
  String? libNetConnectionError = "服务器连接失败";
...
class EnLibString implements LibString {
  ...
  @override
  String? libNetConnectionError = "server connection failed";
...
class JpLibString implements LibString {
  ...
  @override
  String? libNetRequestCancel = "リクエストにキャンセルしました";
  ...
  @override
  String? libNetConnectionError = "サーバ接続に失敗しました";
