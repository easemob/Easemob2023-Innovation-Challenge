...
install_xcframework "${PODS_ROOT}/GoogleUserMessagingPlatform/Frameworks/Release/UserMessagingPlatform.xcframework" "UserMessagingPlatform" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
