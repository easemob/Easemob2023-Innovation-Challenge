...
install_xcframework "${PODS_ROOT}/Google-Mobile-Ads-SDK/Frameworks/GoogleMobileAdsFramework/GoogleMobileAds.xcframework" "GoogleMobileAds" "framework" "ios-arm64" "ios-arm64_x86_64-simulator"
