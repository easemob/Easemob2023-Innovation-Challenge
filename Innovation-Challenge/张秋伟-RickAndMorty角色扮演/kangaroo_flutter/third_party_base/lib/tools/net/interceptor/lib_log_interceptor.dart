...
class LibLogInterceptor extends Interceptor {
  ...
  void onRequest(
    ...
    LogManager.log.d(builder.toString(),tag: "${SysConfig.libNetTag}Request");
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) async {
    ...
    _printResponse(response,builder,(message){
      LogManager.log.d(message,tag: "${SysConfig.libNetTag}Response");
    });
    ...
    if (error) {
      ...
      if (err.response != null) {
        _printResponse(err.response!,builder,(message){
          LogManager.log.e(message,tag: "${SysConfig.libNetTag}Error");
        });
      }else{
        LogManager.log.e(builder.toString(),tag: "${SysConfig.libNetTag}Error");
      }
    }
  ...
  void _printResponse(Response response,StringBuffer builder,LibLogPrint pr) {
    ...
    if (responseBody) {
      ...
      // } on Exception catch (e) {
      //   LogManager.log.d(res,tag: "${SysConfig.libNetTag}ResponseJson");
      // }
    }
    pr(builder.toString());
