...
![](Screenshots/login.png "登录界面")![](Screenshots/login2.png "登录界面")
...
* 目前已有的机器人账号均是提前创建好的
  ...
  ![](Screenshots/register.png "注册界面") ![](Screenshots/register2.png "注册成功")
#### 2.1.3 服务配置
...
![](Screenshots/friends.png "好友分组列表")![](Screenshots/friends2.png "快速定位好友")
...
![](Screenshots/chat1.png "聊天")![](Screenshots/chat2.png "聊天")![](Screenshots/chat3.png  "聊天")![](Screenshots/chat4.png "聊天")![](Screenshots/chat5.png "聊天")![](Screenshots/chat6.png "聊天")![](Screenshots/chat7.png "聊天")
...
* 遇到提示更换用户名即可，后续显示主要为用户昵称，昵称不要求唯一
  ...
  ![](Screenshots/warning_id_not_unique.png "注册用户名已存在")
#### 2.3.2 消息发送频繁
