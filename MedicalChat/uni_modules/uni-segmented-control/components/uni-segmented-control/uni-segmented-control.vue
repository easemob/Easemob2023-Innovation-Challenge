<template>
	<view :class="[styleType === 'text'?'segmented-control--text' : 'segmented-control--button' ]"
		:style="{ borderColor: styleType === 'text' ? '' : '' }" class="segmented-control">
		...
		index === 0&&styleType === 'button' ? 'segmented-control__item--button--first': '',
			...
			:style="{ backgroundColor: index === currentIndex && styleType === 'button' ? '' : 'rgb(241, 241, 241)',borderColor: index === currentIndex&&styleType === 'text'||styleType === 'button'?'':'transparent' }"
